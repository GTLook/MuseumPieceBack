  ...
  return knex(TABLE_NAME).del()
    .then(() => {
      return knex(TABLE_NAME).insert([
        {id: 1, gallery_shortid: SHORTID.generate(), museum_id: 1, artist_id: 1, gallery_picture: "https://upload.wikimedia.org/wikipedia/commons/b/ba/Vincent_van_Gogh_-_Wheatfield_with_crows_-_Google_Art_Project.jpg", gallery_title: "Permant Collection", gallery_text: "Explore Vincent van Gogh's masterpieces in the permanent collection. See his development as an artist in the museum galleries. Get to know his ideas and ambitions and step into Van Gogh's world."},

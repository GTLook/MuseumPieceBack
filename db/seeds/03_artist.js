  ...
  return knex(TABLE_NAME).del()
    .then(() => {
      return knex(TABLE_NAME).insert([
        ...
        {id: 3, artist_shortid: SHORTID.generate(), artist_name: 'John Grade', artist_bio:'Grade’s work is exhibited internationally in museums, galleries, and outdoors in urban spaces and nature. His projects are designed to change over time and often involve collaboration with large groups of people. He lives and works in Seattle.'},
